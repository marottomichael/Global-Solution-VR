...
const STAT_FIELDS = [
    { key: 'totalSolicitacoes', label: 'Experiências solicitadas' },
    { key: 'totalConcluidas', label: 'Simulações concluídas' },
    { key: 'mediaAvaliacoes', label: 'Satisfação média', decimal: true },
    { key: 'mediaConfiabilidade', label: 'Confiabilidade dos dados', decimal: true }
];
