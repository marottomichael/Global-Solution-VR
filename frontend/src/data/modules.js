...
export const HOME_MODULES = [
    ...
    { id: 'produto', title: 'MEMORA Glass', description: 'Imersão sensorial com visão panorâmica ajustada por comandos de voz e IA.', tag: 'Hardware', video: VIDEOS.memoraProduct, view: 'view-produto' }
];
